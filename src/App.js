...
function App() {
  ...
  return (
    <Router>
      ...
      <NavLink activeClassName="active-link" to="/effect">
        effect
      </NavLink>
      <NavLink activeClassName="active-link" to="/context">
        context
      </NavLink>
      <NavLink activeClassName="active-link" to="/custom">
        custom
      </NavLink>
      <NavLink activeClassName="active-link" to="/ref">
        ref
      </NavLink>
      <NavLink activeClassName="active-link" to="/layouteffect">
        layouteffect
      </NavLink>
      <NavLink activeClassName="active-link" to="/callback">
        callback
      </NavLink>
      <NavLink activeClassName="active-link" to="/memo">
        memo
      </NavLink>
      <NavLink activeClassName="active-link" to="/reducer">
        reducer
      </NavLink>
      <NavLink activeClassName="active-link" to="/impe">
        impe
      </NavLink>
